...
START_TEST(s21_mul_36) {
  ...
  src1.bits[0] = 0b00000000000100101101011010000111;
  src1.bits[1] = 0b00000000000000000000000000000000;
  src1.bits[2] = 0b00000000000000000000000000000000;
  ...
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000110100000000000000000;
  value_type_result = s21_mul(src1, src2, &result);
  value_type_origin = 2;
  origin.bits[0] = 0b00000000000000000000000000000000;
  origin.bits[1] = 0b00000000000000000000000000000000;
...
int main(void) {
  ...
  tcase_add_test(tc1_1, ss21_add_);
  ...
  tcase_add_test(tc1_1, ss21_add_0);
  tcase_add_test(tc1_1, ss21_add_1);
  tcase_add_test(tc1_1, ss21_add_2);
  tcase_add_test(tc1_1, ss21_add_3);
  tcase_add_test(tc1_1, ss21_add_4);
  tcase_add_test(tc1_1, ss21_add_5);
  tcase_add_test(tc1_1, ss21_add_6);
  tcase_add_test(tc1_1, ss21_add_8);
  ...
  tcase_add_test(tc1_1, test_s21_from_int_to_decimal_1);
  tcase_add_test(tc1_1, test_s21_from_int_to_decimal_2);
  tcase_add_test(tc1_1, test_s21_from_int_to_decimal_3);
  tcase_add_test(tc1_1, from_int_to_decimal1);
  tcase_add_test(tc1_1, from_int_to_decimal2);
  tcase_add_test(tc1_1, from_int_to_decimal3);
  ...
  tcase_add_test(tc1_1, from_decimal_to_int2);
  ...
  tcase_add_test(tc1_1, s21_add_test_20);
