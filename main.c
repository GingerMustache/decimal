...
int main(void) {
  ...
  // s21_from_int_to_decimal(1234567891, &bit_number);  // 10
  // s21_from_int_to_decimal(2000000000, &bit_number_2);
  ...
  // printf("Output = %d\n",
  //  s21_from_float_to_decimal(0.00000000000000000002, &bit_number));

  // printf("Output = %d\n", s21_from_float_to_decimal(
  //                             0.000003, &bit_number_2));
